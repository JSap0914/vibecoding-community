...
# Common dependencies
# VIBECODING: Removed cache mounts for Railway compatibility - build will be slower but will work
...
# VIBECODING: Removed cache mounts for Railway compatibility
...
## Default runtime image (used when no build target is specified, e.g. Railway)
